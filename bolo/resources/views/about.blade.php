...
@section('content')
    <div class="m-0 p-0 row w-100">
        ...
        <div class="account-page">
            <h5>About</h5>
            <p>Bolo Records is a little online shop, newly opened, located online, shipping from northwestern Wisconsin. The
                stock is old music (80s-90s). The style runs ambient to tribal, folk to house. The hope is to present
                records (tapes? CDs?) that are “new” to most, but there will certainly be a good run of sought after items,
                too.</p>
            <p>I want to keep things simple. I wanna keep pricing inside of what I consider “reasonable.” Haha, what does
            ...
            <p>Registered USPS is the preferred shipping carrier. All items are sent registered and within 2-3 business
                days. Please add any specific details in your order form. Contact me if you need an electronic receipt for
